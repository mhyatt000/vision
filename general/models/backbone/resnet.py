...
class StemWithFixedBatchNorm(BaseStem):
    def __init__(self):
        super(StemWithFixedBatchNorm, self).__init__(norm_func=FrozenBatchNorm2d)
...
class StemWithBatchNorm(BaseStem):
    def __init__(self):
        super(StemWithBatchNorm, self).__init__(norm_func=BatchNorm2d)
...
class StemWithNaiveSyncBatchNorm(BaseStem):
    def __init__(self):
        super(StemWithNaiveSyncBatchNorm, self).__init__(norm_func=NaiveSyncBatchNorm2d)
...
class StemWithSyncBatchNorm(BaseStem):
    def __init__(self):
        super(StemWithSyncBatchNorm, self).__init__(norm_func=SyncBatchNorm)
...
class StemWithGN(BaseStem):
    def __init__(self):
        super(StemWithGN, self).__init__(norm_func=group_norm)
