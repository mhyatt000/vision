...
class BoxHead(nn.Module):
    ...
    def __init__(self):
        ...
        self.feature_extractor = build_box_feature_extractor()
        self.predictor = build_box_predictor()
        self.post_processor = build_box_post_processor()
        self.loss_evaluator = build_box_loss_evaluator()
